...
/**
 * Publication details: Authors: Lin, Z., Yang, Q., Guo, Z., Li, J. Year: 2011
 * Title: An Improved Autoregressive Method with Kalman Filtering Theory for
 * Vessel Motion Predication Published In: International Journal of Intelligent
 * Engineering and Systems Volume: 4 (4)
 * 
...
//        }
		...
		for (int index = order + 1; index < inputs.length; index++) {
			...
			// processModel = new DefaultProcessModel(B, null, Q, new
			// ArrayRealVector(coeffs), kf.getErrorCovarianceMatrix());
