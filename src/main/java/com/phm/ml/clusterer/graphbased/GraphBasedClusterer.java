 ...
 * @param <E>
 */
public class GraphBasedClusterer<V extends Instance, E extends Edge> implements Clusterer {

	protected Triangulator<V, E> triangMethod;
	protected GraphClusterer<V, E> clusterer;

	public GraphBasedClusterer(Triangulator<V, E> tm, GraphClusterer<V, E> ef) {
