...
public class Neuron extends FeatureEntity {
	...
	public Neuron(ParametersContainer param, NeuronConnectionsContainer cc, Instance c) {
		super(c, param);
		connections = (NeuronConnectionsContainer) cc;
		initialize();
	}

	public Neuron(ParametersContainer param, NeuronConnectionsContainer cc, double[] c) {
		super(c, param);
		connections = (NeuronConnectionsContainer) cc;
		initialize();
	}

	public Neuron(ParametersContainer param, NeuronConnectionsContainer cc, int c) {
		super(c, param);
		connections = (NeuronConnectionsContainer) cc;
		initialize();
	}

	public Neuron(ParametersContainer param, Instance c) {
		super(c, param);
		connections = new NeuronConnectionsContainer(this);
		initialize();
	}

	public Neuron(ParametersContainer param, double[] c) {
		super(c, param);
		connections = new NeuronConnectionsContainer(this);
		initialize();
	}

	public Neuron(ParametersContainer param, int c) {
		super(c, param);
		connections = new NeuronConnectionsContainer(this);
		initialize();
	}
	...
	public boolean equals(Object obj) {
		return (obj != null && obj instanceof Neuron && obj.hashCode() == hashCode());
	}
