...
public class MGNGTrainingSupervisor extends GNGTrainingSupervisor {
	...
	protected NNResult prepareResult(Neuron neuron, Instance signal, List<Neuron> winners, NNResult resc) {
		...
		resc.setParameter(MGNGTrainingSupervisor.MGNG_GLOBAL_CONTEXT,
				neuron.getParameter(MGNGTrainingSupervisor.MGNG_GLOBAL_CONTEXT));
		...
		resc.setParameter(MGNGTrainingSupervisor.NEURON_LOCAL_CONTEXT,
				neuron.getParameter(MGNGTrainingSupervisor.NEURON_LOCAL_CONTEXT));
		return resc;
	}
