...
//        result.add(ns.get(1));
	...
	protected void afterWinnersFinding(NeuronGroup ngroup, List<Neuron> winners, Instance signal) {
		// Empty body
	}

	// Update Winners stage /////////////////////////
	protected void onWinnersUpdate(NeuronGroup ngroup, List<Neuron> winners, Instance signal) {
	...
	protected Neuron initNewNeuron(NeuronGroup ngroup, Neuron firstn, Neuron secondn) {
		double[] newWeight = new double[Math.min(firstn.noAttributes(), secondn.noAttributes())];
	...
	protected NNResult prepareResult(Neuron neuron, Instance signal, List<Neuron> winners, NNResult resc) {
		...
		resc.setParameter(GNGTrainingSupervisor.GNG_EPSILON_B_KEY,
				neuron.getParameter(GNGTrainingSupervisor.GNG_EPSILON_B_KEY));
		resc.setParameter(GNGTrainingSupervisor.GNG_EPSILON_N_KEY,
				neuron.getParameter(GNGTrainingSupervisor.GNG_EPSILON_N_KEY));
		resc.setParameter(GNGTrainingSupervisor.GNG_ERRORRATE_A_KEY,
				neuron.getParameter(GNGTrainingSupervisor.GNG_ERRORRATE_A_KEY));
		resc.setParameter(GNGTrainingSupervisor.GNG_ERRORRATE_B_KEY,
				neuron.getParameter(GNGTrainingSupervisor.GNG_ERRORRATE_B_KEY));
		resc.setParameter(GNGTrainingSupervisor.GNG_LANDA_KEY,
				neuron.getParameter(GNGTrainingSupervisor.GNG_LANDA_KEY));
		resc.setParameter(GNGTrainingSupervisor.GNG_MAX_EDGE_AGE_KEY,
				neuron.getParameter(GNGTrainingSupervisor.GNG_MAX_EDGE_AGE_KEY));
		resc.setParameter(GNGTrainingSupervisor.NEURON_DISTANCE,
				neuron.getParameter(GNGTrainingSupervisor.NEURON_DISTANCE));
		resc.setParameter(GNGTrainingSupervisor.NEURON_DIS_DIMENSION,
				neuron.getParameter(GNGTrainingSupervisor.NEURON_DIS_DIMENSION));
		resc.setParameter(GNGTrainingSupervisor.NEURON_LOCALERROR,
				neuron.getParameter(GNGTrainingSupervisor.NEURON_LOCALERROR));
		return resc;
	}
