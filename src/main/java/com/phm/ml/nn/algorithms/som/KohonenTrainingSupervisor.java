...
public class KohonenTrainingSupervisor extends Supervisor {
	...
	public KohonenTrainingSupervisor(KohonenInitializer init, NeuronDistanceMethod dm, NeuronDistanceMethod udm,
	...
	protected NNResult prepareResult(Neuron neuron, Instance signal, List<Neuron> winners, NNResult resc) {
		...
		resc.setParameter(KohonenTrainingSupervisor.KOHONEN_DEVIATION_FINAL,
				neuron.getParameter(KohonenTrainingSupervisor.KOHONEN_DEVIATION_FINAL));
		resc.setParameter(KohonenTrainingSupervisor.KOHONEN_DEVIATION_INIT,
				neuron.getParameter(KohonenTrainingSupervisor.KOHONEN_DEVIATION_INIT));
		resc.setParameter(KohonenTrainingSupervisor.KOHONEN_EPSILON_FINAL,
				neuron.getParameter(KohonenTrainingSupervisor.KOHONEN_EPSILON_FINAL));
		resc.setParameter(KohonenTrainingSupervisor.KOHONEN_EPSILON_INIT,
				neuron.getParameter(KohonenTrainingSupervisor.KOHONEN_EPSILON_INIT));
		resc.setParameter(KohonenTrainingSupervisor.KOHONEN_HEIGHT_DIMENSION,
				neuron.getParameter(KohonenTrainingSupervisor.KOHONEN_HEIGHT_DIMENSION));
		resc.setParameter(KohonenTrainingSupervisor.KOHONEN_NEURONS_GRIDS,
				neuron.getParameter(KohonenTrainingSupervisor.KOHONEN_NEURONS_GRIDS));
		resc.setParameter(KohonenTrainingSupervisor.KOHONEN_TIME_CONSTANT,
				neuron.getParameter(KohonenTrainingSupervisor.KOHONEN_TIME_CONSTANT));
		resc.setParameter(KohonenTrainingSupervisor.KOHONEN_WIDTH_DIMENSION,
				neuron.getParameter(KohonenTrainingSupervisor.KOHONEN_WIDTH_DIMENSION));
		resc.setParameter(KohonenTrainingSupervisor.NEURON_DISTANCE,
				neuron.getParameter(KohonenTrainingSupervisor.NEURON_DISTANCE));
		resc.setParameter(KohonenTrainingSupervisor.NEURON_DIS_DIMENSION,
				neuron.getParameter(KohonenTrainingSupervisor.NEURON_DIS_DIMENSION));
		resc.setParameter(KohonenTrainingSupervisor.NEURON_GRID_X,
				neuron.getParameter(KohonenTrainingSupervisor.NEURON_GRID_X));
		resc.setParameter(KohonenTrainingSupervisor.NEURON_GRID_Y,
				neuron.getParameter(KohonenTrainingSupervisor.NEURON_GRID_Y));
		resc.setParameter(KohonenTrainingSupervisor.NEURON_UPDATE_DISTANCE,
				neuron.getParameter(KohonenTrainingSupervisor.NEURON_UPDATE_DISTANCE));
		return resc;
	}
}
