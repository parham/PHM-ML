 ...
 * @author phm
 */
public class MITSSLGaussianARTMAPTest {
    ...
    public static void main(String[] args) {
        DefaultDataset db = MITSSLDataset.loadMITSSLDataset(new File("/home/phm/Datasets/ChapelleSS/benchmark/SSL,set=7,X.tab"), 
                                                            new File("/home/phm/Datasets/ChapelleSS/benchmark/SSL,set=7,y.tab"), 4);
