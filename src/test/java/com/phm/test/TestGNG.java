...
public class TestGNG {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage img = ImageIO.read(new File("/home/phm/Pictures/20151021_123936.jpg"));
...
//        frMain.setVisible(true);
        ...
        GraphVisualComponent<Neuron, Connection> gvc = new GraphVisualComponent<>(group);
        frMain.addGraph(gvc);
        frMain.setVisible(true);
//        GraphFrame<Neuron, Connection> frMain = new GraphFrame (true);
//        frMain.setNodeSize(30, 30);
//        frMain.setNodeShape(mxConstants.SHAPE_ELLIPSE);
//        frMain.setSize(800, 800);
//        frMain.setGraph(group);
//        frMain.setVisible(true);
