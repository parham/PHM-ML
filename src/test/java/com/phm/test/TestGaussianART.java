...
//        GaussianARTTrainingSupervisor<DataField<float []>> tmp = 
//                new GaussianARTTrainingSupervisor<> (2, 
//                new LinkedList<float[]>(),
//                new GaussianARTActivationMethod (), 
//                new GaussianARTMatchMethod (),
//                new GaussianARTUpdateMethod ());
//        GaussianARTTrainingSupervisor<DataField<float []>> tmp = 
//                new GaussianARTTrainingSupervisor<> (2, 
//                new LinkedList<float[]> (),
//                new GaussianARTActivationMethod (), 
//                new GaussianARTMatchMethod (),
//                new GaussianARTUpdateMethod ());
        GaussianARTTrainingSupervisor tmp = new GaussianARTTrainingSupervisor();
        tmp.initialize(group);
        group.supervisors.add(tmp);
        //group.setParameter(FUZZYART_LEARNING_RATE, 1.0f);
