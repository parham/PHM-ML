 ...
 * @author phm
 */
public class GeoLifeGARTMAPMain {
...
//        
        ...
        gng.initialize(ng);
//        ng.setParameter(ARTTrainingSupervisor.ART_VIGILANCE_PARAMTER, 0.8f);
//        ng.setParameter(NEURON_DEFAULT_STD, 0.1f);
        ...
        File pathres = new File ("/run/media/phm/PHM/PHM - I AM ONE/Projects/INCREMENTAL NEURAL NETWORK PROJECTS/Extended Gaussian-TopoART/Dataset/Geolife Trajectories 1.3/gart.csv");
