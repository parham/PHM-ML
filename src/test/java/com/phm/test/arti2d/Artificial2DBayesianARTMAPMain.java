 ...
 * @author phm
 */
public class Artificial2DBayesianARTMAPMain {
    ...
    public static void main(String[] args) {
        ...
        BayesianARTTrainingSupervisor gart = new BayesianARTTrainingSupervisor (2);
...
//        });
        ...
        // Testing phase
        BayesianARTTrainingSupervisor gartTest = new BayesianARTTrainingSupervisor(2);
