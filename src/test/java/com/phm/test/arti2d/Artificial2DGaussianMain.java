...
import com.phm.ml.nn.algorithms.art.topoart.TopoFuzzyARTTrainingSupervisor;
 ...
 * @author phm
 */
public class Artificial2DGaussianMain {
...
//        TopoEGARTTrainingSupervisor gart = new TopoEGARTTrainingSupervisor (new PhmGARTLRC(1.0f, 0.00005f, 0.000001f)); // new DefaultLRC()
        ng.supervisors.add(gart);
        gart.initialize(ng);
        //ng.setParameter(TGART_CORRESPONDENT_THRESH, 0.00001f);
        ng.setParameter(TGART_CF_MIN, 0.01f);
        ng.setParameter(ART_VIGILANCE_PARAMTER, 0.5f);
