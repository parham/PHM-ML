...
//            TopoEGARTTrainingSupervisor tegart = new TopoEGARTTrainingSupervisor ();
            ...
            group.setParameter(ART_VIGILANCE_PARAMTER, 0.2f);
...
//                }
            ...
            FileHandler.exportDataset(ddsv, new File("/home/phm/HAR_CART_2.csv"));
