 ...
 * @author phm
 */
public class Image2DSignalGenerator extends ListedSignalGenerator {
    public Image2DSignalGenerator (BufferedImage img, Color thresh, ListedSignalGenerator.GeneratorPolicy gp) {
    ...
    public static String convertColor2String (Color color) {
