...
public class NGTrainingSupervisor extends Supervisor {
    ...
    protected NNResult prepareResult(Neuron neuron, Instance signal, List<Neuron> winners, NNResult resc) {
        ...
        resc.setParameter(NGTrainingSupervisor.NEURON_DISTANCE, neuron.getParameter(NGTrainingSupervisor.NEURON_DISTANCE));
        resc.setParameter(NGTrainingSupervisor.NEURON_ASSIGNED_VALUE, neuron.getParameter(NGTrainingSupervisor.NEURON_ASSIGNED_VALUE));
        resc.setParameter(NGTrainingSupervisor.NEURON_DIS_DIMENSION, neuron.getParameter(NGTrainingSupervisor.NEURON_DIS_DIMENSION));
        ...
        resc.setParameter(NGTrainingSupervisor.SIGNALS_NUMBER, neuron.getParameter(NGTrainingSupervisor.SIGNALS_NUMBER));
