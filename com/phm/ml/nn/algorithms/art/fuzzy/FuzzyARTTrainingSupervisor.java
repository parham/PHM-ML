...
public class FuzzyARTTrainingSupervisor extends ARTTrainingSupervisor {
    ...
    protected NNResult prepareResult(Neuron neuron, Instance signal, List<Neuron> winners, NNResult resc) {
        ...
        resc.setParameter(FuzzyARTTrainingSupervisor.FUZZYART_CHOICE_PARAMTER, neuron.getParameter(FuzzyARTTrainingSupervisor.FUZZYART_CHOICE_PARAMTER));
        resc.setParameter(FuzzyARTTrainingSupervisor.FUZZYART_LEARNING_RATE, neuron.getParameter(FuzzyARTTrainingSupervisor.FUZZYART_LEARNING_RATE));
        resc.setParameter(FuzzyARTTrainingSupervisor.ART_RESONANCE_OCCURED, neuron.getParameter(FuzzyARTTrainingSupervisor.ART_RESONANCE_OCCURED));
        resc.setParameter(FuzzyARTTrainingSupervisor.ART_TEMPLATES_LIMIT, neuron.getParameter(FuzzyARTTrainingSupervisor.ART_TEMPLATES_LIMIT));
        resc.setParameter(FuzzyARTTrainingSupervisor.ART_VIGILANCE_PARAMTER, neuron.getParameter(FuzzyARTTrainingSupervisor.ART_VIGILANCE_PARAMTER));
        resc.setParameter(FuzzyARTTrainingSupervisor.NEURON_ACTIVATION_VALUE, neuron.getParameter(FuzzyARTTrainingSupervisor.NEURON_ACTIVATION_VALUE));
        return resc;
    }
