...
public class GNGSimulateSupervisor extends Supervisor {
    ...
    protected NNResult prepareResult(Neuron neuron, Instance signal, List<Neuron> winners, NNResult resc) {
        ...
        resc.setParameter(GNGSimulateSupervisor.NEURON_DISTANCE, neuron.getParameter(GNGSimulateSupervisor.NEURON_DISTANCE));
        resc.setParameter(GNGSimulateSupervisor.NEURON_DIS_DIMENSION, neuron.getParameter(GNGSimulateSupervisor.NEURON_DIS_DIMENSION));
        resc.setParameter(GNGSimulateSupervisor.NEURON_LOCALERROR, neuron.getParameter(GNGSimulateSupervisor.NEURON_LOCALERROR));
        return resc;
    }
}
