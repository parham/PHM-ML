...
public class OnlineSemiSupervisedGNGSupervisor extends GNGTrainingSupervisor {
    ...
    public OnlineSemiSupervisedGNGSupervisor(NeuronDistanceMethod dm,
            PredictionStrategy ps,
            LabelingStrategy ls,
            String deflabel) {  
        super(dm);
    ...
    protected NNResult prepareResult(Neuron neuron, Instance signal, List<Neuron> winners, NNResult resc) {
        ...
        resc.setParameter(OnlineSemiSupervisedGNGSupervisor.OSSNEURON_LABEL, neuron.getParameter(OnlineSemiSupervisedGNGSupervisor.OSSNEURON_LABEL));
        return resc;
    }
}
